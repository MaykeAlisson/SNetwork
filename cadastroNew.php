    ...
    <div class="col-md-8" id="formulario"> 
      <form method="post" action="usuarioDAO.php" id="formCadastro">
        ...
        <div class="form-group col-md-6">
          <label>Usuário</label>
          <input class="form-control" type="text" name="" id="" placeholder="Digite seu usuários" required>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          ...
          <select name="profissao" id="profissao" class="form-control">
            <option selected="">Selecione sua 2ª Profissão</option>
            <?php
            $profissoes = listaProfissao($conexao);
            foreach ($profissoes as $profissao) {
              ?>
        ...
        <!--CAMPO PROFICAO 3 -->
        <div class="form-group col-md-6">
          <label for="inputProfissao">3ª Profissão</label>
          <select name="profissao" id="profissao" class="form-control">
            <option selected="">Selecione sua 3ª Profissão</option>
            <?php
            $profissoes = listaProfissao($conexao);
            foreach ($profissoes as $profissao) {
              ?>
        ...
        <!--CAMPO PROFICAO 4º-->
        <div class="form-group col-md-6">
          <label for="inputProfissao">4ª Profissão</label>
          <select name="profissao" id="profissao" class="form-control">
            <option selected="">Selecione sua 4ª Profissão</option>
            <?php
            $profissoes = listaProfissao($conexao);
            foreach ($profissoes as $profissao) {
              ?>
      ...
      <div class="form-group col-md-12">
        ...
        <input class="form-control" type="text" name="telefone" size="14" class="phone-ddd-mask" placeholder="(00) 00000-0000" maxlength="14" id="telefone" required="requered" style="width: 160px">
      </div>
